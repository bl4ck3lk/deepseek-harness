...
import githubRemote from '@deepseek-ai/dsh-github/remote'
...
export type {} from '@deepseek-ai/dsh-github/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, githubRemote, dynamicRemote, pluginInventoryRemote, messageFeedbackRemote,
    ]) {
