/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-github-app`.
 * @module @deepseek-ai/dsh-github-app/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@deepseek-ai/dsh-invariants'

const PACKAGE_NAME = '@deepseek-ai/dsh-github-app'

/** Cordis companion plugin name. */
export const name = 'github-app-bundle-invariant'
