...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  GithubThreadId: 'github.md',
  GithubCommitSha: 'github.md',
  GithubRepoRef: 'github.md',
  GithubPrState: 'github.md',
  GithubMergeable: 'github.md',
  GithubChecksState: 'github.md',
  GithubReviewDecision: 'github.md',
  GithubReviewEvent: 'github.md',
  GithubMergeMethod: 'github.md',
  GithubThreadFilter: 'github.md',
  GithubPrSummary: 'github.md',
  GithubCheckContext: 'github.md',
  GithubChecksSummary: 'github.md',
  GithubThreadSummary: 'github.md',
  GithubThreadComment: 'github.md',
  GithubThreadFull: 'github.md',
  GithubCommitInfo: 'github.md',
  GithubPrDetail: 'github.md',
  GithubContextDigest: 'github.md',
  GithubFailure: 'github.md',
  GithubSuccess: 'github.md',
  GithubRejected: 'github.md',
  GithubResult: 'github.md',
  GithubErrorCode: 'github.md',
  GithubListPullRequestsRequest: 'github.md',
  GithubPullRequestListValue: 'github.md',
  GithubPullRequestRequest: 'github.md',
  GithubListThreadsRequest: 'github.md',
  GithubThreadListValue: 'github.md',
  GithubThreadRequest: 'github.md',
  GithubListCommitsRequest: 'github.md',
  GithubCommitListValue: 'github.md',
  GithubGetContextRequest: 'github.md',
  GithubAddCommentRequest: 'github.md',
  GithubReplyToThreadRequest: 'github.md',
  GithubSetThreadResolvedRequest: 'github.md',
  GithubSubmitReviewRequest: 'github.md',
  GithubMergePullRequestRequest: 'github.md',
  GithubClosePullRequestRequest: 'github.md',
  GithubReopenPullRequestRequest: 'github.md',
  GithubCommentCreatedValue: 'github.md',
  GithubThreadResolutionValue: 'github.md',
  GithubReviewSubmittedValue: 'github.md',
  GithubPullRequestMergedValue: 'github.md',
  GithubPullRequestStateValue: 'github.md',
  GithubConfig: 'github.md',
