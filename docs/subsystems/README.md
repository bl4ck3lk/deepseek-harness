...
| [github.md](github.md) | the authenticated `gh` CLI gateway for GitHub pull requests: GraphQL reads, review-thread mutations, reviews, merges, TTL caching, and write/enrichment gating |
